...
describe('Archive Strategies', () => {
    ...
    beforeEach(() => {
        TestBed.configureTestingModule({
            providers: [provideHttpClient(), TemplateInterpolator],
        });
    ...
    describe('DynamicCategoryStrategy', () => {
        ...
        it('should include globs if available in defaults', async () => {
            ...
            vi.spyOn(interpolator, 'interpolate').mockImplementation((tmpl, ctx) =>
                ctx['globs'] ? 'with globs' : 'without globs',
            );
